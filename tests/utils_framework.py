...
if tf.__version__.startswith("2.0"):
    ...
    from tensorflow.random import set_seed as set_seed
...
from tensorflow.keras.layers import UpSampling2D as tUpSampling2d
...
getters_dict = {
    ...
    KRLoss: partial(
        get_instance_withreplacement, dict_keys_replace={"true_values": None}
    ),
    HKRLoss: partial(
        get_instance_withreplacement, dict_keys_replace={"true_values": None}
    ),
